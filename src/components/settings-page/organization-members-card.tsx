    ...
    return (
        <Card x-chunk="dashboard-04-chunk-1">
            <CardHeader>
                ...
                <CardDescription>
                    See, manage and invite your team members.
                </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex justify-end">
                            {inviteButtonDisabled ?
                                (<Button disabled><Loader2 className="animate-spin h-4 w-4 mr-2" />Please wait</Button>) :
                                (<Button onClick={inviteMember} disabled={!isEmail(email)}>Invite member</Button>)
                            }
                        </div>
                    </div>
